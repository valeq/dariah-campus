...
## **The LexO-lite web editor: a quick tutorial for creating an Ontolex-compliant basic lexical resource**
...
In the following, the functionalities of LexO will be shown with some more details by means of a series of short video tutorials. 

**How to create LexO's users.**
This video shows the management of the users' profiles.

<Video provider="youtube" id="9KE0laMaTAs" />

**How to create lexicon languages.** 
This video shows the languages creation process.

<Video provider="youtube" id="GWaKk6ZEk14" />

**How to edit a core lexical entry.**

This video shows the management of the core module
<Video provider="youtube" id="YkKNCHiE4u0" />

**How to encode the denotation of a sense**

<Video provider="youtube" id="IWvIWBz5S-8" />

**How to edit lexical and semantic relations between lexical items** 

The following video will guide you through the encoding of lexical and semantic relations between items according to the OntoLex Variation and Translations module (_vartrans)_.

<Video provider="youtube" id="lEHhkthTJq8" />

**How to create a Multiword lexical entry**
This video will show how to create a multi-word entry following the Ontolex model, that is by making explicit its components parts and linking them to the corresponding singe-word entries in the lexicon. 

The video will also function as a useful recap of the key parts of the encoding of an entry: sense and lexical / semantic relation encoding.

<Video provider="youtube" id="DWNSs-Huixc" />

** Additional features**
<Video provider="youtube" id="NaySLjUvlhE"  />


This video concludes the tutorial that guide you into the creation of basic multilingual lexical resources with LexO.

## The &lt;TEI&gt;enricher tool

**&lt;TEI&gt;enricher** is a tool for quickly creating a dictionary in accordance with the Guidelines of the Text Encoding Initiative (TEI), ideally in the Lex-0 flavour. It was created in the framework of the Viennese Corpus of Arabic Varieties (VICAV) project at the Austrian Centre for Digital Humanities and Cultural Heritage (ACDH-CH).

To take the tutorial please follow the link [here](https://howto.acdh-dev.oeaw.ac.at/de/resource/posts/a-very-concise-guide-to-creating-lexical-resources-with-%CB%82tei%CB%83enricher)
