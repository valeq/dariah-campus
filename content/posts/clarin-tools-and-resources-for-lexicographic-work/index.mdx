...
<VideoCard provider="youtube" id="9KE0laMaTAs" title="User Profile Management" subtitle="Click here to view" image="https://i.imgur.com/pgX79zX.png" />

**How to create lexicon languages.** 
This video shows the languages creation process.

<VideoCard provider="youtube" id="GWaKk6ZEk14" title="Add a new language" subtitle="Click here to view" image="https://i.imgur.com/2PetnmC.png" />

**How to edit a core lexical entry.**

This video shows the management of the core module

<VideoCard provider="youtube" id="YkKNCHiE4u0" title="Create a basic entry" subtitle="Click here to view" image="https://i.imgur.com/y4il8AU.png" />
